    ...
    return (
        <div>
            ...
            <div className="header-parent">
                    <h2 className="header">
                        <h2 className="ticker-header">{TickerValue.current.toUpperCase()} </h2>Financials
                ...
                <div className="col-lg-12">
                    <IncomeStatementCard showTicker={tickerShown} />
                </div>
                <div className="col-lg-12">
                    <BalanceSheetCard showTicker={tickerShown} />
                </div>
                <div className="col-lg-12">
                    <CashFlowCard showTicker={tickerShown} />
                </div>
            </div>
        </div>
    );
